...
export default function Navbar() {
    ...
    return (
        <div className="bg-white dark:bg-[#17192D] py-3 px-5 flex justify-between items-center">
            
            {/* Logo */}
            <svg className='fill-blue-500 dark:fill-white w-44' viewBox="317.35 452.61 1285.3 174.78" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-row space-x-3 items-center">
                ...
                {companies.map((company) => (
                    <button key={company.id} className="text-white bg-blue-900 hover:bg-blue-500 transition py-1 px-3 flex flex-row space-x-2 items-center">
                        <img src={companySvg} />
                        <b>{company.name}</b>
                    </button>
                ))}
