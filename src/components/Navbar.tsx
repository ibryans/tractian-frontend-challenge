...
export default function Navbar() {
    ...
    return (
        <div className="w-full bg-white dark:bg-[#17192D] h-20 px-5 flex justify-between items-center transition duration-500">
            
            {/* Logo */}
            <svg className='fill-blue-600 dark:fill-white w-48' viewBox="317.35 452.61 1285.3 174.78" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-row items-center">
                ...
                {companies.map((company) => (
                    <button key={company.id} className="text-white bg-blue-900 hover:bg-blue-500 transition rounded-md py-2 px-4 flex flex-row space-x-2 items-center mx-2 text-xl">
